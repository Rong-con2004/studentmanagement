...
public class Login extends javax.swing.JFrame {
    ...
    public boolean isEmpty() {
        if (jTextField1.getText().isEmpty() || String.valueOf(jPasswordField1.getPassword()).isEmpty()) {
            JOptionPane.showMessageDialog(this, "username or password are not blank ");
            return false;
        }
        return true;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 100, 280, 26));

        jPasswordField1.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jPanel1.add(jPasswordField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 150, 280, 26));
